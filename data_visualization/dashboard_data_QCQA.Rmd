...
```{r echo=FALSE}
# Comments/Notes
# 1) Make variables generalizable for different variable names - USE AMERIFLUX NAMES HERE (make sure to update plots below) - make scatterplot generalizable - Temperature scatterplot could be more generalizable & make line names more generalizable
...
```{r}
# Barometric pressure 
pressure_p <- plotly_loop(data,vars_pressure)%>%
